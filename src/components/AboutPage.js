        ...
        <main>
            ...
            <Container maxWidth="sm">
                ...
                <Typography variant="h5" align="justify" color="text.secondary" paragraph> 
                    The Turing Machine is a computational model that was invented by Alan Turing in 1936. 
                    It was the original model of the computer and it is equivalent to modern computers on a theoretical level.
                    For his work on the Turing Machine, the theory of computing, and other projects involving mathematics and computer science,
                    Turing is considered the father of modern computer science.
                </Typography>
                ...
                <Typography variant="h5" align="justify" color="text.secondary" paragraph>
                    ...
                    a modern day computer can do. This is because Turing Machines contain memory, and are able process instructions
                    to return an output. They are therefore able to perform any task a computer can do. 
                </Typography>
